preprocessing_FSMS_files_with_yields_types = {'numquest': 'float64', 'ident': 'float64', 'enqu': 'category',
                                                    'hors nk': 'category', 'moughataa': 'category',
                                                    'commune': 'category',
                                                    ...
                                                    'Pondérations': 'float64', 'Extrap': 'float64',
                                                    'Trage1': 'category',
